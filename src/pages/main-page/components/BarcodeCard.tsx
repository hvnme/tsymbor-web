...
const BarcodeCard: React.FC<BarcodeCardProps> = ({
    ...
    useEffect(() => {
        if (barcodeValue) {
            const normalized = barcodeValue.replace(/\D/g, '').padStart(12, '0').slice(0, 12);
    ...
    return (
        <div className="w-full max-w-sm mx-auto">
            ...
            >
                <Card className="bg-black/15 backdrop-blur-md border border-white/5 shadow-xl shadow-black/28">
                    <CardContent className="p-3">
                        {/* Область штрих-кода с GlowEffect */}
                        <div className="relative mb-4">
                            {/* GlowEffect за штрих-кодом */}
                            <GlowEffect
                            ...
                            {/* Контейнер штрих-кода */}
                            <div className="relative z-10 bg-gradient-to-b from-gray-50 to-white/90 rounded-xl p-3 overflow-hidden shadow-xl">
                                {normalizedValue && barcodeLoaded ? (
                                    ...
                                    <div className="flex items-center justify-center gap-2 text-gray-500 h-24">
                                        ...
                                        <span className="font-medium text-base">Генерація EAN-13...</span>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        >
                            {/* Баланс */}
                            <motion.div
                                className="bg-black/10 rounded-xl p-3 border border-white/5 text-center shadow-xl"
                            ...
                            >
                                <div className="flex items-center justify-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm text-white/40 font-medium">Баланс</span>
                                </div>
                            ...
                            >
                                <div className="flex items-center justify-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm text-white/40 font-medium">Кава</span>
                                </div>
