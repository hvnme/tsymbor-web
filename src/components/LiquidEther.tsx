...
const defaultColors = ["#00b4f0", "#001dad", "#f0e800"];
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      onScroll() {
        ...
        // Очищаємо таймер і створюємо новий для завершення сесії скролу
        if (this.scrollTimer) clearTimeout(this.scrollTimer);
      ...
      update() {
        ...
        // Дуже плавне затухання scroll ефекту
        if (this.isScrolling) {
          // Експоненціальне затухання з дуже високою плавністю
          this.smoothScrollPos.x *= 0.98;
          this.smoothScrollPos.y *= 0.98;
